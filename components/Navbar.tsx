  ...
  return (
    <div className="navbar top-0 left-0 right-0 z-10  p-4 bg-transparent">
      <div className="navbar-start">
          ...
          >
            ...
            {/* <li tabIndex={0}>
              ...
              <ul className="p-2 bg-base-100">
                ...
                <li>
                  <a>Profil Satu Data Deli Serdang</a>
                </li>
              </ul>
            </li> */}
            <li>
        ...
        <a
          className="btn btn-ghost bg-base-900 normal-case sm:text-xl text-sm text-start"
          href="/"
        >
          <img
            src="/assets/image/Group1darkkabupaten.png"
            alt="Logo"
